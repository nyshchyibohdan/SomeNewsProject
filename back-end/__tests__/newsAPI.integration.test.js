...
describe("Інтеграційні тести для функціоналу отримання новин з NewsAPI", () => {
    ...
    it("T_007 GET /api/newsapi/:topic --- помилка 400 --- відсутня категорія новин :topic", async () => {
    ...
    it("T_008 GET /api/newsapi/:topic --- успіх 200 --- :topic введено коректно ([general, technology, sport, science])", async () => {
