...
describe('Інтеграційні тести для сторінки авторизації користувача веб-додатку', () => {
    ...
    test('Перевірка можливості перейти на сторінку реєстрації', async () => {
        renderReusable(
            ['/login'],
            [
    ...
    test('НЕВДАЛЕ надсилання запиту на авторизацію зі сторінки /login', async () => {
        renderReusable(
            ['/login'],
            [
                { path: '/login', element: <Login /> },
    ...
    test('УСПІШНЕ надсилання запиту на авторизацію зі сторінки /login', async () => {
        renderReusable(
            ['/login'],
            [
                { path: '/login', element: <Login /> },
